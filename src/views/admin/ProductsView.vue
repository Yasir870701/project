<template>
  <VContainer>
    <VRow>
      ...
      <!-- <VDivider></VDivider> -->
      <VCol cols="11" >
        <VBtn color="#6969" @click="openDialog">新增項目</VBtn>
        <VDataTableServer
        ...
        >
          ...
          <template #[`item.image`]="{ item }">
            <VImg :src="item.raw.image" height="40px"></VImg>
          </template>
    ...
    <VForm :disabled="isSubmitting" @submit.prevent="submit">
      <VCard>
        ...
        <VCardActions block>
          ...
          <VSpacer></VSpacer>
          <VSpacer></VSpacer>
          <VBtn color="red" @click="closeDialog" :loading="isSubmitting" size="25px">取消</VBtn>
          <VSpacer></VSpacer>
          <VBtn color="green" type="submit" :loading="isSubmitting" size="25px">送出</VBtn>
          <VSpacer></VSpacer>
          <VSpacer></VSpacer>
          <VSpacer></VSpacer>
          <VSpacer></VSpacer>
